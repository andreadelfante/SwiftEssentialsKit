...
extension HorizontalSelectionView: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let identifier = cellIdentifier else {
            fatalError("Please register first a cell of type HorizontalSelectionViewCell")
        }

        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as? HorizontalSelectionViewCell else {
            fatalError("Your cell class must extend HorizontalSelectionViewCell")
        }
